...
//   Tras os campos dos apartamentos cadastrados
    ...
    $scope.deleteFotoApe  = function(fotoApe ) {
      RestSrv.delete(fotoApeUrl, fotoApe , function(status,data) {
    ...
    $scope.saveFotoApe  = function(fotoApe ) {
      if (fotoApe .id ) {
        RestSrv.edit(fotoApeUrl,fotoApe , function(status,data) {
        ...
        RestSrv.add(fotoApeUrl, fotoApe , function(status,data ) {
    ...
    RestSrv.find(fotoApeUrl,function(status,data) {
    $scope.fotoApes = data;
